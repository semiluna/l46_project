...
class GATLayer(nn.Module):
    ...
    def forward(self, g, h, snorm_n, train_mask, fixed_mask):
        ...
        outputs = [attn_head(g, h, snorm_n, train_mask, fixed_mask) for attn_head in self.heads]

        head_outs = [head_out for head_out, _ in outputs]
        middle_feats = [middle_f for _, middle_f in outputs]
        ...
        return h, torch.stack(middle_feats, dim=1)
